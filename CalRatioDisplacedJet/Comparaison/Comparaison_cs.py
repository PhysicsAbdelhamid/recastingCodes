...
# Charger les données cross section GLUONS
cross_section_file1 = "Plots_High/HAHM_new_version/1000_275/Cross_section/Cross_section_mH1000_mS275_nevents5000.txt"
cross_section_data1 = np.loadtxt(cross_section_file1)

# Charger les données de la première ctau
ctau_file1 = "Plots_High/HAHM_new_version/1000_275/Cross_section/Cross_section_mH1000_mS275_nevents5000_ctau.txt"
ctau_data1 = np.loadtxt(ctau_file1)

# Charger les données cross section HAHM_VARIABLE
cross_section_file2 = "Plots_High/HAHM_old_version/1000_275/Cross_section/Cross_section_mH1000_mS275_nevents5000.txt"
cross_section_data2 = np.loadtxt(cross_section_file2)

# Charger les données de la deuxième ctau
ctau_file2 = "Plots_High/HAHM_old_version/1000_275/Cross_section/Cross_section_mH1000_mS275_nevents5000_ctau.txt"
...
ax1.set_ylabel(r'95% CL limit on $\sigma \times B$ [pb]')
ax1.set_xscale('log')
ax1.set_yscale('log')
ax1.grid(True)
ax1.legend()
...
ax2.set_ylabel('Ratio of cross-sections')
ax2.set_xscale('log')
ax2.set_ylim(0, 2)
...
plt.show()
plt.savefig('Comparaison/Cross_section/Cross_section_mH1000_ms275_nevents5000.png')