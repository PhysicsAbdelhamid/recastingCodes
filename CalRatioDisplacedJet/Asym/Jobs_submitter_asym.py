...
OutDir = "/users/divers/atlas/millot/scratch/Recasting_HAHM_asym_version/Results_new"   # "/users/divers/atlas/millot/scratch/Recasting_HAHM_past_version" or "/users/divers/atlas/millot/scratch/Recasting_HAHM_gluons_version"

model = "HAHM_asymmetric_UFO"  
mode = "new" 

#if ctaus are the same use below and comment lines 35 and 36
ctaus = [ [ct,ct] for ct in np.geomspace(0.1,1e2, 200) ] 

#for different ctaus comment line 32 and use below :
#ct1_values =np.geomspace(0.1, 10, 15)
#ct2_values =np.geomspace(0.1, 10, 15)

Lambda ="100"
k="1"

for mass_Phi, mass_S1, mass_S2 in masses:
  for ct1, ct2 in ctaus:  #if same ctaus, use line 41 comment line 42 & 43
  #for ct1 in ct1_values:   #if different ctaus, use lines 42 & 43 and comment line 41
    #for ct2 in ct2_values:
      print(f"Creating job for ct1 = {ct1}, ct2 = {ct2}")  # Debugging print
