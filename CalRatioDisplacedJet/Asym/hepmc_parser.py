...
# Ajouter le chemin du parent package pour les imports relatifs
sys.path.append('/AtlasDisk/home2/millot/MG5_aMC_v3_4_2/recastingCodes/CalRatioDisplacedJet')

# Ajoutez le chemin où madgraph est installé
sys.path.append('/users/divers/atlas/millot/home2/MG5_aMC_v3_4_2')

#try:
#    import madgraph
#except ModuleNotFoundError:
#    print("Module 'madgraph' not found.")
#    print("Current sys.path:", sys.path)
#   sys.exit(1)

# Importation de hepmc_parser après avoir configuré sys.path
