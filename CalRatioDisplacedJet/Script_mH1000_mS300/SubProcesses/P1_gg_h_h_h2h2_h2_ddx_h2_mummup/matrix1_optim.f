...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      CALL OXXXXX(P(0,5),MDL_MM,+1,+1*IC(5),W(1,11))  !  count 2
      CALL OXXXXX(P(0,5),MDL_MM,-1,+1*IC(5),W(1,12))  !  count 2
      CALL IXXXXX(P(0,6),MDL_MM,+1,-1*IC(6),W(1,13))  !  count 2
      CALL IXXXXX(P(0,6),MDL_MM,-1,-1*IC(6),W(1,14))  !  count 2
      CALL FFS1_3(W(1,13),W(1,11),GC_28,MDL_MHSINPUT,FK_MDL_WHS,W(1,15))
     $  !  count 2
      CALL FFS1_3(W(1,13),W(1,12),GC_28,MDL_MHSINPUT,FK_MDL_WHS,W(1,16))
     $  !  count 2
      CALL FFS1_3(W(1,14),W(1,11),GC_28,MDL_MHSINPUT,FK_MDL_WHS,W(1,17))
     $  !  count 2
      CALL FFS1_3(W(1,14),W(1,12),GC_28,MDL_MHSINPUT,FK_MDL_WHS,W(1,18))
     $  !  count 2
