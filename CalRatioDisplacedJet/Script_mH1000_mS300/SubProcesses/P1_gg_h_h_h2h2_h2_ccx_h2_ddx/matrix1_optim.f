...
C     ----------
     ...
     $    ABS(mdl_MHinput*small_width_treatment)), mdl_WH)
      ...
      CALL OXXXXX(P(0,5),MDL_MD,+1,+1*IC(5),W(1,13))  !  count 1
      CALL OXXXXX(P(0,5),MDL_MD,-1,+1*IC(5),W(1,14))  !  count 1
      CALL IXXXXX(P(0,6),MDL_MD,+1,-1*IC(6),W(1,15))  !  count 1
      CALL IXXXXX(P(0,6),MDL_MD,-1,-1*IC(6),W(1,16))  !  count 1
      CALL FFS1_3(W(1,15),W(1,13),GC_24,MDL_MHSINPUT,FK_MDL_WHS,W(1,17))
     $  !  count 4
      CALL FFS1_3(W(1,16),W(1,14),GC_24,MDL_MHSINPUT,FK_MDL_WHS,W(1,18))
     $  !  count 4
