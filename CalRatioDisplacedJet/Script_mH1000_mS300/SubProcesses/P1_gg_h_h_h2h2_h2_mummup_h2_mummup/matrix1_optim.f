...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      CALL OXXXXX(P(0,3),MDL_MM,+1,+1*IC(3),W(1,5))  !  count 2
      CALL OXXXXX(P(0,3),MDL_MM,-1,+1*IC(3),W(1,6))  !  count 2
      CALL IXXXXX(P(0,4),MDL_MM,+1,-1*IC(4),W(1,7))  !  count 2
      CALL IXXXXX(P(0,4),MDL_MM,-1,-1*IC(4),W(1,8))  !  count 2
      CALL FFS1_3(W(1,7),W(1,5),GC_28,MDL_MHSINPUT,FK_MDL_WHS,W(1,9))  !  count 4
      CALL FFS1_3(W(1,7),W(1,6),GC_28,MDL_MHSINPUT,FK_MDL_WHS,W(1,10))  !  count 2
      CALL FFS1_3(W(1,8),W(1,5),GC_28,MDL_MHSINPUT,FK_MDL_WHS,W(1,11))  !  count 2
      CALL FFS1_3(W(1,8),W(1,6),GC_28,MDL_MHSINPUT,FK_MDL_WHS,W(1,12))  !  count 4
