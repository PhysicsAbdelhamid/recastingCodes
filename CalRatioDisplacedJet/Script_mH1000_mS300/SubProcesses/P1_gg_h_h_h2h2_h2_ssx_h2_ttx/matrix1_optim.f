...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WT)
      ...
      CALL FFS1_3(W(1,7),W(1,5),GC_30,MDL_MHSINPUT,FK_MDL_WHS,W(1,9))  !  count 4
      CALL FFS1_3(W(1,7),W(1,6),GC_30,MDL_MHSINPUT,FK_MDL_WHS,W(1,10))  !  count 4
      CALL FFS1_3(W(1,8),W(1,5),GC_30,MDL_MHSINPUT,FK_MDL_WHS,W(1,11))  !  count 4
      CALL FFS1_3(W(1,8),W(1,6),GC_30,MDL_MHSINPUT,FK_MDL_WHS,W(1,12))  !  count 4
      CALL OXXXXX(P(0,5),MDL_MT,+1,+1*IC(5),W(1,13))  !  count 2
      CALL OXXXXX(P(0,5),MDL_MT,-1,+1*IC(5),W(1,14))  !  count 2
      CALL IXXXXX(P(0,6),MDL_MT,+1,-1*IC(6),W(1,15))  !  count 2
      CALL IXXXXX(P(0,6),MDL_MT,-1,-1*IC(6),W(1,16))  !  count 2
      CALL FFS1_3(W(1,15),W(1,13),GC_32,MDL_MHSINPUT,FK_MDL_WHS,W(1,17))
     $  !  count 4
      CALL FFS1_3(W(1,15),W(1,14),GC_32,MDL_MHSINPUT,FK_MDL_WHS,W(1,18))
     $  !  count 4
      CALL FFS1_3(W(1,16),W(1,13),GC_32,MDL_MHSINPUT,FK_MDL_WHS,W(1,19))
     $  !  count 4
      CALL FFS1_3(W(1,16),W(1,14),GC_32,MDL_MHSINPUT,FK_MDL_WHS,W(1,20))
     $  !  count 4
