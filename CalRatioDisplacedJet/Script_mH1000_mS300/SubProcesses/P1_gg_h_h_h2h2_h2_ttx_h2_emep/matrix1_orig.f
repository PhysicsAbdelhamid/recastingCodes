...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WT)
      ...
      CALL FFS1_3(W(1,4),W(1,3),GC_32,MDL_MHSINPUT, FK_MDL_WHS,W(1,5))
      CALL OXXXXX(P(0,5),MDL_ME,NHEL(5),+1*IC(5),W(1,4))
      CALL IXXXXX(P(0,6),MDL_ME,NHEL(6),-1*IC(6),W(1,3))
      CALL FFS1_3(W(1,3),W(1,4),GC_26,MDL_MHSINPUT, FK_MDL_WHS,W(1,6))
      CALL SSS1_1(W(1,5),W(1,6),GC_17,MDL_MHINPUT, FK_MDL_WH,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL VVS1_0(W(1,1),W(1,2),W(1,3),GC_3,AMP(1))
