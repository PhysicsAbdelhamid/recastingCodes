...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      CALL FFS1_3(W(1,7),W(1,5),GC_36,MDL_MHSINPUT,FK_MDL_WHS,W(1,9))  !  count 2
      CALL FFS1_3(W(1,8),W(1,6),GC_36,MDL_MHSINPUT,FK_MDL_WHS,W(1,10))  !  count 2
      CALL OXXXXX(P(0,5),MDL_ME,+1,+1*IC(5),W(1,11))  !  count 1
      CALL OXXXXX(P(0,5),MDL_ME,-1,+1*IC(5),W(1,12))  !  count 1
      CALL IXXXXX(P(0,6),MDL_ME,+1,-1*IC(6),W(1,13))  !  count 1
      CALL IXXXXX(P(0,6),MDL_ME,-1,-1*IC(6),W(1,14))  !  count 1
      CALL FFS1_3(W(1,13),W(1,11),GC_26,MDL_MHSINPUT,FK_MDL_WHS,W(1,15))
     $  !  count 2
      CALL FFS1_3(W(1,14),W(1,12),GC_26,MDL_MHSINPUT,FK_MDL_WHS,W(1,16))
     $  !  count 2
      CALL SSS1_1(W(1,9),W(1,15),GC_17,MDL_MHINPUT,FK_MDL_WH,W(1,17))  !  count 2
      CALL SSS1_1(W(1,9),W(1,16),GC_17,MDL_MHINPUT,FK_MDL_WH,W(1,18))  !  count 2
      CALL SSS1_1(W(1,10),W(1,15),GC_17,MDL_MHINPUT,FK_MDL_WH,W(1,19))  !  count 2
      CALL SSS1_1(W(1,10),W(1,16),GC_17,MDL_MHINPUT,FK_MDL_WH,W(1,20))  !  count 2
