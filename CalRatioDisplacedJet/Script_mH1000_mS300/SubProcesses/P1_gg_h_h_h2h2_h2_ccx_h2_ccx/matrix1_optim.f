...
C     ----------
     ...
     $    ABS(mdl_MHinput*small_width_treatment)), mdl_WH)
      ...
      CALL FFS1_3(W(1,15),W(1,13),GC_22,MDL_MHSINPUT,FK_MDL_WHS,W(1,17))
     $  !  count 4
      CALL FFS1_3(W(1,15),W(1,14),GC_22,MDL_MHSINPUT,FK_MDL_WHS,W(1,18))
     $  !  count 2
      CALL FFS1_3(W(1,16),W(1,13),GC_22,MDL_MHSINPUT,FK_MDL_WHS,W(1,19))
     $  !  count 2
      CALL FFS1_3(W(1,16),W(1,14),GC_22,MDL_MHSINPUT,FK_MDL_WHS,W(1,20))
     $  !  count 4
