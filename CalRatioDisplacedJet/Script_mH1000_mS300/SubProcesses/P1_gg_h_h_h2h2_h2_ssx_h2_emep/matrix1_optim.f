...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      CALL FFS1_3(W(1,7),W(1,5),GC_30,MDL_MHSINPUT,FK_MDL_WHS,W(1,9))  !  count 2
      ...
      CALL FFS1_3(W(1,8),W(1,6),GC_30,MDL_MHSINPUT,FK_MDL_WHS,W(1,12))  !  count 2
      CALL OXXXXX(P(0,5),MDL_ME,+1,+1*IC(5),W(1,13))  !  count 1
      CALL OXXXXX(P(0,5),MDL_ME,-1,+1*IC(5),W(1,14))  !  count 1
      CALL IXXXXX(P(0,6),MDL_ME,+1,-1*IC(6),W(1,15))  !  count 1
      CALL IXXXXX(P(0,6),MDL_ME,-1,-1*IC(6),W(1,16))  !  count 1
      CALL FFS1_3(W(1,15),W(1,13),GC_26,MDL_MHSINPUT,FK_MDL_WHS,W(1,17))
     $  !  count 4
      CALL FFS1_3(W(1,16),W(1,14),GC_26,MDL_MHSINPUT,FK_MDL_WHS,W(1,18))
     $  !  count 4
      CALL SSS1_1(W(1,9),W(1,17),GC_17,MDL_MHINPUT,FK_MDL_WH,W(1,19))  !  count 2
      CALL SSS1_1(W(1,9),W(1,18),GC_17,MDL_MHINPUT,FK_MDL_WH,W(1,20))  !  count 2
      CALL SSS1_1(W(1,10),W(1,17),GC_17,MDL_MHINPUT,FK_MDL_WH,W(1,21))  !  count 2
      CALL SSS1_1(W(1,10),W(1,18),GC_17,MDL_MHINPUT,FK_MDL_WH,W(1,22))  !  count 2
      CALL SSS1_1(W(1,11),W(1,17),GC_17,MDL_MHINPUT,FK_MDL_WH,W(1,23))  !  count 2
      CALL SSS1_1(W(1,11),W(1,18),GC_17,MDL_MHINPUT,FK_MDL_WH,W(1,24))  !  count 2
      CALL SSS1_1(W(1,12),W(1,17),GC_17,MDL_MHINPUT,FK_MDL_WH,W(1,25))  !  count 2
      CALL SSS1_1(W(1,12),W(1,18),GC_17,MDL_MHINPUT,FK_MDL_WH,W(1,26))  !  count 2
