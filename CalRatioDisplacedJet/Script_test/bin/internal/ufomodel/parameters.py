...
y1 = Parameter(name = 'y1',
               nature = 'internal',
               type = 'real',
               value = '(cmath.pi*hbar*ms1**2*v**2)/(MB**2*(-4*MB**2 + ms1**2)**1.5 + MC**2*(-4*MC**2 + ms1**2)**1.5 + MD**2*(-4*MD**2 + ms1**2)**1.5 + MS**2*(-4*MS**2 + ms1**2)**1.5 + MTA**2*(ms1**2 - 4*MTA**2)**1.5 + (3*ct1*MU**2*(ms1**2 - 4*MU**2)**1.5)/c)',
               texname = '\\text{y1}')

y2 = Parameter(name = 'y2',
               nature = 'internal',
               type = 'real',
               value = '(cmath.pi*hbar*ms2**2*v**2)/(MB**2*(-4*MB**2 + ms2**2)**1.5 + MC**2*(-4*MC**2 + ms2**2)**1.5 + MD**2*(-4*MD**2 + ms2**2)**1.5 + MS**2*(-4*MS**2 + ms2**2)**1.5 + MTA**2*(ms2**2 - 4*MTA**2)**1.5 + (3*ct2*MU**2*(ms2**2 - 4*MU**2)**1.5)/c)',
               texname = '\\text{y2}')
