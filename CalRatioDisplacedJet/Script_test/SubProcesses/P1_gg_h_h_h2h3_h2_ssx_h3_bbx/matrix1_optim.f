...
C     ----------
     ...
     $    ABS(mdl_ms2*small_width_treatment)), mdl_Ws2)
      ...
      CALL FFS1_3(W(1,15),W(1,13),GC_15,MDL_MS2,FK_MDL_WS2,W(1,17))  !  count 4
      CALL FFS1_3(W(1,15),W(1,14),GC_15,MDL_MS2,FK_MDL_WS2,W(1,18))  !  count 4
      CALL FFS1_3(W(1,16),W(1,13),GC_15,MDL_MS2,FK_MDL_WS2,W(1,19))  !  count 4
      CALL FFS1_3(W(1,16),W(1,14),GC_15,MDL_MS2,FK_MDL_WS2,W(1,20))  !  count 4
