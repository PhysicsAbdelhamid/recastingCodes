...
C     ----------
     ...
     $    ABS(mdl_ms2*small_width_treatment)), mdl_Ws2)
      ...
      CALL FFS1_3(W(1,7),W(1,6),GC_10,MDL_MS1,FK_MDL_WS1,W(1,10))  !  count 2
      CALL FFS1_3(W(1,8),W(1,5),GC_10,MDL_MS1,FK_MDL_WS1,W(1,11))  !  count 2
      ...
      CALL FFS1_3(W(1,15),W(1,14),GC_21,MDL_MS2,FK_MDL_WS2,W(1,18))  !  count 2
      CALL FFS1_3(W(1,16),W(1,13),GC_21,MDL_MS2,FK_MDL_WS2,W(1,19))  !  count 2
