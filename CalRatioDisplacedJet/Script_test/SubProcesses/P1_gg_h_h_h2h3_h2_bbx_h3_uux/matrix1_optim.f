...
C     ----------
     ...
     $    ABS(mdl_ms2*small_width_treatment)), mdl_Ws2)
      ...
      CALL OXXXXX(P(0,5),MDL_MU,+1,+1*IC(5),W(1,13))  !  count 2
      CALL OXXXXX(P(0,5),MDL_MU,-1,+1*IC(5),W(1,14))  !  count 2
      CALL IXXXXX(P(0,6),MDL_MU,+1,-1*IC(6),W(1,15))  !  count 2
      CALL IXXXXX(P(0,6),MDL_MU,-1,-1*IC(6),W(1,16))  !  count 2
      CALL FFS1_3(W(1,15),W(1,13),GC_21,MDL_MS2,FK_MDL_WS2,W(1,17))  !  count 4
      CALL FFS1_3(W(1,15),W(1,14),GC_21,MDL_MS2,FK_MDL_WS2,W(1,18))  !  count 4
      CALL FFS1_3(W(1,16),W(1,13),GC_21,MDL_MS2,FK_MDL_WS2,W(1,19))  !  count 4
      CALL FFS1_3(W(1,16),W(1,14),GC_21,MDL_MS2,FK_MDL_WS2,W(1,20))  !  count 4
