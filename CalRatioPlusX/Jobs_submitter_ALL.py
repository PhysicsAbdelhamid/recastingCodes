...
workDir = "/users/divers/atlas/haddad/home2/MG5_aMC_v3_4_2/recastingCodes/CalRatioPlusX"
...
OutDir = "/users/divers/atlas/haddad/scratch/RecastingScratch"  
...
for mode, model, params in masses:
    ...
    #(not working, script need to be generated)os.system(f"{InDir}/bin/mg5_aMC -f {OutDir}/script_{slug}.txt")
    os.system(f"qsub -q prod1C7@clratlserv04 -o {OutDir} -e {OutDir} {OutDir}/Job_{slug}.sh")
    print(f"{OutDir}/Job_{slug}.sh") #prod2C7@clratlserv04
